...
np.save("./output/N_reg_ave_ts_0.npy", N_batch_ave_ts_0)
np.save("./output/N_reg_std_ts_0.npy", N_batch_std_ts_0)
np.save("./output/Z_reg_ave_ts_0.npy", Z_batch_ave_ts_0)
np.save("./output/Z_reg_std_ts_0.npy", Z_batch_std_ts_0)
...
np.save("./output/N_reg_ave_ts_1.npy", N_batch_ave_ts_1)
np.save("./output/N_reg_std_ts_1.npy", N_batch_std_ts_1)
np.save("./output/Z_reg_ave_ts_1.npy", Z_batch_ave_ts_1)
np.save("./output/Z_reg_std_ts_1.npy", Z_batch_std_ts_1)